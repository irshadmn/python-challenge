...
# Create empty lists to track variables
total_months = []
total_profit = [] 
...
with open(csvpath, newline ="", encoding = "utf - 8") as csvfile:
    ...
    # create variable csvreader and store the contents of budget_data.csv
...
# We use the plus 1 at the end since month assosiated with change is the +1 month or next month
